...
import { ScriptTypeEnum } from '../../core/enums/index.js';
  ...
  validatePositiveNumbers() {
    [
      ...
      if (!validationUtils.isPositiveNumber(value)) {
        throw new Error(
          `Invalid or no ${key} parameter was found: Expected a number but received: ${value} (10000008)`
        );
      }
    });
  }
  ...
  validateStrings() {
    ...
    [
      ...
      if (!validationUtils.isExists(value)) {
        throw new Error(
          `Invalid or no ${key} parameter was found: Expected a string but received: ${value} (1000009)`
        );
      }
    });
  }
  ...
  validateBooleans() {
    [
      ...
      if (!validationUtils.isValidBoolean(value)) {
        throw new Error(
          `Invalid or no ${key} parameter was found: Expected a boolean but received: ${value} (1000010)`
        );
      }
    });
  }
  ...
  validateArrays() {
    [
      ...
      if (!validationUtils.isValidArray(value)) {
        throw new Error(
          `Invalid or no ${key} parameter was found: Expected a array but received: ${value} (1000011)`
        );
      }
    });
  }
  ...
  validateSpecial() {
    ...
    [
      ...
      if (!validationUtils.isValidLink(value)) {
        throw new Error(
          `Invalid or no ${key} parameter was found: Expected a valid URL but received: ${value} (1000013)`
        );
      }
    });
  }
  ...
  validateDirectories() {
    ...
    [
      ...
      if (!fileUtils.isDirectoryPath(value)) {
        throw new Error(
          `The parameter path ${key} marked as directory but it's a path of a file: ${value} (1000014)`
        );
      }
    });
  }
